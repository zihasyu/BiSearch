...
# sudo rm Containers/*
# sudo echo 3 > /proc/sys/vm/drop_caches
./BiSearch -i $path -c 4 -m 5 -n $num  -R 1 -L 0 >SA_BiSearch_deflate_Restore_testdebug$name.txt
}
run_method /mnt/dataset2/cross_c++_tar _cross_gcc_tar 40
# run_method /mnt/dataset2/cross_c++_tar/glibc_tarballs/glibc_tarballs _glibc 30
