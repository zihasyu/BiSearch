...
# ============================================================
#  tos_git_restore_loop5.sh  (方法: chain=1)
#
#  运行 tos_git_restore.sh 共 5 轮。
...
NUM_RUNS=5
METHOD_NAME="chain=1"
RESULT_DIR="./TosGit_restore_loop5"
SRC_DIR="./TosGit_chain1"   # 与 tos_git_restore.sh 中 EXPERIMENT_BASE_DIR 一致
